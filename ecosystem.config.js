  ...
  apps: [
    ...
    },
    {
      ...
      env_development: {
        ...
        OPENTELEMETRY_COLLECTOR_HTTP_TRACES: "http://localhost:9012/v1/traces",
        OPENTELEMETRY_COLLECTOR_HTTP_METRICS:
          "http://localhost:9012/v1/metrics",
        OPENTELEMETRY_COLLECTOR_HTTP_LOGS: "http://localhost:9012/v1/logs",
